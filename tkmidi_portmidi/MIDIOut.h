...
///          17Jan2016, 29Feb2016, 04Mar2016, 12Nov2020, 20Jan2023
///
///
///
...
#define MIDIOUT_MAXEVENTS 1024 // maximum number of outgoing PortMidi events (Pm_OpenOutput param)
...
public:
   sBool openByIdxInt (sUI _idx, sBool _bQuiet);
...
public:
   ...
   */
   YM sSI  GetDeviceTypeByIdx (sUI _idx);
