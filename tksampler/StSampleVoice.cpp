...
void StSampleVoice::reallyStartVoice(const StSampleVoiceNoteOnParams *_params,
   ...
   if(!b_glide || sample->b_glide_retrig_sample)
   {
      ...
      if(0 == current_sample_len)
      {
         ...
         if(!handleEndOfLoop(&current_play_offset,
                             ...
                             &dummy/*smpDatLRX*/,
#endif // TKSAMPLER_SKIP_LIVEREC
                             sample->b_from_start/*bFromStart*/,
                             YAC_TRUE/*bAllowCOffReset*/
                             )
            )
         {
   ...
   for(sUI pluginIdx = 0u; pluginIdx < STSAMPLE_NUM_PLUGINS; pluginIdx++)
   {
      ...
      if(NULL != pce)
      {
         ...
         pce->voice->note_hz           =
            noteToFreq(sF32(note))
#ifndef TKSAMPLER_SKIP_LIVEREC
            * liverec_osc_pitch_factor
#endif // TKSAMPLER_SKIP_LIVEREC
            ;
         ...
         if(!adsr_vol.isFinished())
         {
                ...
                )
            {
               ...
               else if(sample->b_noteoff_immediate_loop_jump)  //  || b_timedloop
               {
                  ...
                  sF32 *dummy;
                  handleEndOfLoop(&current_play_offset,
                                  &dummy/*smpDat*/,
#ifndef TKSAMPLER_SKIP_LIVEREC
                                  &dummy/*smpDatLRX*/,
#endif // TKSAMPLER_SKIP_LIVEREC
                                  YAC_FALSE/*bFromStart*/,
                                  YAC_TRUE/*bAllowCOffReset*/
                                  );
               }
            }
         ...
         if(mmdst.jumptoloop >= 0.0f)
         {
            ...
            if(mmJumpToLoopIdx != current_loop_idx)
            {
               ...
               if(!b_playing)
               {
                  ...
                  (void)handleEndOfLoop(&current_play_offset,
                                        &dummy/*smpDat*/,
#ifndef TKSAMPLER_SKIP_LIVEREC
                                        &dummy/*smpDatLRX*/,
#endif // TKSAMPLER_SKIP_LIVEREC
...
void StSampleVoice::handleEndOfLoopOver(const sF32  *_smpDatCur,
                                        sUI          _frameOffOver,
...
sBool StSampleVoice::handleEndOfLoop(sF64 *cOff,
                                     sF32**smpDat,
#ifndef TKSAMPLER_SKIP_LIVEREC
                                     sF32 **smpDatLRX,
#endif // TKSAMPLER_SKIP_LIVEREC
...
#ifndef TKSAMPLER_SKIP_WAVETABLE
void StSampleVoice::readWindowedSample(const sF32 *smpDat,
#ifndef TKSAMPLER_SKIP_LIVEREC
                                       const sF32 *smpDatLRX,
#endif // TKSAMPLER_SKIP_LIVEREC
   ...
   const sSI interpolType = sample->getCurrentInterpolType();

   sUI smpOff = intOff * numCh;
   if(_bAllowInterpol && STSAMPLE_INTERPOL_LINEAR == interpolType)
   {
   ...
   else if(_bAllowInterpol && STSAMPLE_INTERPOL_VSR2 == interpolType)
   {
#define VSR_NUM 2
      sF64 fetchOffC = _off;
...
#undef VSR_NUM
   ...
   else if(_bAllowInterpol && STSAMPLE_INTERPOL_VSR4 == interpolType)
   {
#define VSR_NUM 4
      sF64 fetchOffC = _off;
      const sF64 cRateVSR  = _cRate * (1.0f / VSR_NUM);
...
#undef VSR_NUM
   ...
   else if(_bAllowInterpol && STSAMPLE_INTERPOL_VSR8 == interpolType)
   {
#define VSR_NUM 8
      sF64 fetchOffC = _off;
      const sF64 cRateVSR  = _cRate * (1.0f / VSR_NUM);
...
#undef VSR_NUM
   ...
   else if(_bAllowInterpol && STSAMPLE_INTERPOL_VSR16 == interpolType)
   {
#define VSR_NUM 16
      sF64 fetchOffC = _off;
      const sF64 cRateVSR  = _cRate * (1.0f / VSR_NUM);
...
#undef VSR_NUM
   ...
   else if(_bAllowInterpol && STSAMPLE_INTERPOL_VSR32 == interpolType)
   {
#define VSR_NUM 32
      sF64 fetchOffC = _off;
      const sF64 cRateVSR  = _cRate * (1.0f / VSR_NUM);
...
#undef VSR_NUM
   ...
   else if(_bAllowInterpol && STSAMPLE_INTERPOL_VSR64 == interpolType)
   {
#define VSR_NUM 64
      sF64 fetchOffC = _off;
      const sF64 cRateVSR  = _cRate * (1.0f / VSR_NUM);
...
void StSampleVoice::calcCurrentOffset(void) {
   ...
   if( (
#ifndef TKSAMPLER_SKIP_WAVETABLE
          sample->b_timestretch ||
#endif // TKSAMPLER_SKIP_WAVETABLE
          b_allow_smpoff/*!b_glide*/
        )
       && Dfltnotequal(relSmpOff, last_relsmpoff)
       )
   {
#ifndef TKSAMPLER_SKIP_WAVETABLE
...
void StSampleVoice::renderBlockAdditive(sF32 *    _buf,
   ...
   if(bLerp)
   {
      ...
      if(fragment_interpol < 0.0f)
         ...
         fragment_interpol = 0.0f;
#ifndef TKSAMPLER_SKIP_FRAGMENT_IPOL
                                           ...
                                           )
{
   ...
   cNoteHz = noteToFreq(current_freq + (next_freq - current_freq) * a)
#ifndef TKSAMPLER_SKIP_LIVEREC
      * liverec_osc_pitch_factor
#endif // TKSAMPLER_SKIP_LIVEREC
      ;
   nNoteHz = noteToFreq(current_freq + (next_freq - current_freq) * b)
#ifndef TKSAMPLER_SKIP_LIVEREC
      * liverec_osc_pitch_factor
#endif // TKSAMPLER_SKIP_LIVEREC
      ;
...
// //       return 0;
   ...
   if(STSAMPLE_INTERPOL_LINEAR == interpolType)
   {
      while(k-- > 0)
      {
...
#ifndef TKSAMPLER_PLUGINS_ONLY
sF32 StSampleVoice::readSample1LRX(const sF32 *smpDat,
#ifndef TKSAMPLER_SKIP_LIVEREC
                                   const sF32 *smpDatLRX,
#endif // TKSAMPLER_SKIP_LIVEREC
                                   sSI _off
...
#ifndef TKSAMPLER_PLUGINS_ONLY
sF32 StSampleVoice::readSample1(const sF32 *smpDat,
#ifndef TKSAMPLER_SKIP_LIVEREC
                                const sF32 *smpDatLRX,
#endif // TKSAMPLER_SKIP_LIVEREC
                                sSI _off
   ...
   {
      default:
#ifdef TKSAMPLER_SKIP_PLAY_XFADE
...
#ifndef TKSAMPLER_SKIP_PLAY_XFADE
      case STSAMPLE_PLAY_MODE_XFADE_ALL:
         r = readSample1LRX(smpDat,
#ifndef TKSAMPLER_SKIP_LIVEREC
                            smpDatLRX,
...
#define L 16
            if((current_sample_len >= L) && ((current_smpdat_shift + current_sample_offset) >= L) && (_off >= (sSI(current_sample_len) - L)))
            {
               ...
               sF32 t = readSample1LRX(smpDat - L,
#ifndef TKSAMPLER_SKIP_LIVEREC
                                       (NULL != smpDatLRX) ? (smpDatLRX - L) : NULL,
#endif // TKSAMPLER_SKIP_LIVEREC
                                       winOff
                                       );
...
#undef L
      ...
      case STSAMPLE_PLAY_MODE_XFADE_64:
         ...
         {
#define L 64
            if((current_sample_len >= L) &&
               ((current_smpdat_shift + current_sample_offset) >= L) &&
               (_off >= (sSI(current_sample_len) - L))
               )
            {
               sSI winOff = _off - (((sSI)current_sample_len) - L);
               sF32 t = readSample1LRX(smpDat - L,
...
#ifndef TKSAMPLER_PLUGINS_ONLY
sF32 StSampleVoice::readSample2LRX(const sF32 *smpDat,
#ifndef TKSAMPLER_SKIP_LIVEREC
                                   const sF32 *smpDatLRX,
#endif // TKSAMPLER_SKIP_LIVEREC
                                   sSI _off
...
#ifndef TKSAMPLER_PLUGINS_ONLY
sF32 StSampleVoice::readSample2(const sF32 *smpDat,
#ifndef TKSAMPLER_SKIP_LIVEREC
                                const sF32 *smpDatLRX,
#endif // TKSAMPLER_SKIP_LIVEREC
                                sSI _off
...
#define L 16
            if((current_sample_len >= L) &&
               ((current_smpdat_shift + current_sample_offset) >= L) &&
               (frameOff >= (sSI(current_sample_len) - L))
               )
            {
               sSI winOff = frameOff - (((sSI)current_sample_len) - L);
               sF32 t = readSample2LRX(smpDat - (L<<1),
#ifndef TKSAMPLER_SKIP_LIVEREC
                                       (NULL != smpDatLRX) ? (smpDatLRX - (L<<1)) : NULL,
#endif // TKSAMPLER_SKIP_LIVEREC
                                       (winOff<<1) + (_off & 1)
                                       );
               sF32 amt = sF32(winOff) / sF32(L);
                                         ...
                                         )
{
   ...
   while(fragSize > 0)
   {
      ...
      if(STSAMPLE_INTERPOL_LINEAR == interpolType)
      {
         if(numCh > 1)
         {
            smpL  = readSample2(smpDat,
#ifndef TKSAMPLER_SKIP_LIVEREC
                                smpDatLRX,
#endif // TKSAMPLER_SKIP_LIVEREC
                                smpOff  + 0
                                );
            smpLn = readSample2(smpDat,
#ifndef TKSAMPLER_SKIP_LIVEREC
                                smpDatLRX,
#endif // TKSAMPLER_SKIP_LIVEREC
                                smpOffR + 0
            ...
            smpR  = readSample2(smpDat,
#ifndef TKSAMPLER_SKIP_LIVEREC
                                smpDatLRX,
#endif // TKSAMPLER_SKIP_LIVEREC
                                smpOff  + 1
                                );
            smpRn = readSample2(smpDat,
#ifndef TKSAMPLER_SKIP_LIVEREC
                                smpDatLRX,
#endif // TKSAMPLER_SKIP_LIVEREC
                                smpOffR + 1
         ...
         {
            smpL  = readSample1(smpDat,
#ifndef TKSAMPLER_SKIP_LIVEREC
                                smpDatLRX,
#endif // TKSAMPLER_SKIP_LIVEREC
                                smpOff  + 0
                                );
            smpLn = readSample1(smpDat,
#ifndef TKSAMPLER_SKIP_LIVEREC
                                smpDatLRX,
#endif // TKSAMPLER_SKIP_LIVEREC
                                smpOffR + 0
...
#ifndef TKSAMPLER_SKIP_IPOL_VSR
      else if(STSAMPLE_INTERPOL_VSR2 == interpolType)
      {
#define VSR_NUM 2
...
#undef VSR_NUM
      ...
      else if(STSAMPLE_INTERPOL_VSR4 == interpolType)
      {
#define VSR_NUM 4
         sF64 fetchOffC = fetchOff;
         const sF64 cRateVSR  = cRate * (1.0f / VSR_NUM);
...
#undef VSR_NUM
      ...
      else if(STSAMPLE_INTERPOL_VSR8 == interpolType)
      {
#define VSR_NUM 8
         sF64 fetchOffC = fetchOff;
         const sF64 cRateVSR  = cRate * (1.0f / VSR_NUM);
...
#undef VSR_NUM
      ...
      else if(STSAMPLE_INTERPOL_VSR16 == interpolType)
      {
#define VSR_NUM 16
         sF64 fetchOffC = fetchOff;
         const sF64 cRateVSR  = cRate * (1.0f / VSR_NUM);
...
#undef VSR_NUM
      ...
      else if(STSAMPLE_INTERPOL_VSR32 == interpolType)
      {
#define VSR_NUM 32
         sF64 fetchOffC = fetchOff;
         const sF64 cRateVSR  = cRate * (1.0f / VSR_NUM);
...
#undef VSR_NUM
      ...
      else if(STSAMPLE_INTERPOL_VSR64 == interpolType)
      {
#define VSR_NUM 64
         sF64 fetchOffC = fetchOff;
         const sF64 cRateVSR  = cRate * (1.0f / VSR_NUM);
...
#endif // TKSAMPLER_SKIP_IPOL_LANCZOS
#ifndef TKSAMPLER_SKIP_IPOL_LANCZOS
      else if(STSAMPLE_INTERPOL_LANCZOS4 == interpolType)
      {
#define A 2
...
#define TBL lanczos_tbl_a2
         if(numCh > 1)
         {
            ...
            for(; xo < A; xo++)
            {
               sF32 inSmpL = readSample2(smpDat,
#ifndef TKSAMPLER_SKIP_LIVEREC
                                         smpDatLRX,
#endif // TKSAMPLER_SKIP_LIVEREC
                                         xi+0
                                         );
               sF32 inSmpR = readSample2(smpDat,
#ifndef TKSAMPLER_SKIP_LIVEREC
                                         smpDatLRX,
#endif // TKSAMPLER_SKIP_LIVEREC
                                         xi+1
...
#undef A
      ...
      else if(STSAMPLE_INTERPOL_LANCZOS8 == interpolType)
      {
#define A 4
...
#undef A
      ...
      else if(STSAMPLE_INTERPOL_LANCZOS16 == interpolType)
      {
#define A 8
...
#undef A
      ...
      else if(STSAMPLE_INTERPOL_LANCZOS32 == interpolType)
      {
#define A 16
...
#undef A
      ...
      else if(STSAMPLE_INTERPOL_LANCZOS64 == interpolType)
      {
#define A 32
...
#else
      // Amp output
      last_sample_l = last_sample_l * cVolL * fadeVol;
      last_sample_r = last_sample_r * cVolR * fadeVol;
#endif // TKSAMPLER_SKIP_PLUGINS
   ...
   while(blkSz > 0)
   {
...
#ifndef TKSAMPLER_PLUGINS_ONLY
      {
...
#else
                  Dyac_host_printf("xxx cFreq=%f cNoteHz=%f cRate=%f invRate=%f cRateOct=%f ai_fc=%f\n", current_freq, cNoteHz, cRate, invRate, cRateOct, ai_fc);
#endif // TKSAMPLER_SKIP_LIVEREC
               }
            }
            else
...
#else
                  Dyac_host_printf("xxx cFreq=%f cNoteHz=%f cRate=%f\n", current_freq, cNoteHz, cRate);
#endif // TKSAMPLER_SKIP_LIVEREC
               }
            }
         }
         ...
         if(
            ...
            (0u == br_mask) &&
            (sample->getCurrentInterpolType() <= STSAMPLE_INTERPOL_LINEAR) &&
            ...
            !sample->hasPlugins() &&
#endif // TKSAMPLER_SKIP_PLUGINS
            ((0u == sample->interpol_order) || (STSAMPLE_INTERPOL_NONE == sample->getCurrentInterpolType())) &&
#ifndef TKSAMPLER_SKIP_AA_AI
         ...
         {
            genSizeHint = 0;
            numDone = renderFragmentOptFwdMonoSimple(buf, blkSz, genSizeHint, smpDat, cVolL, cVolR, cRate
#ifndef TKSAMPLER_SKIP_LIVEREC
                                                     , inputs
#endif // TKSAMPLER_SKIP_LIVEREC
                                                     );
         ...
         if(!numDone)
         {
            if(0 != genSizeHint)
            {
               numDone = renderFragmentGeneric(buf, genSizeHint, smpDat,
#ifndef TKSAMPLER_SKIP_LIVEREC
                                               smpDatLRX,
#endif // TKSAMPLER_SKIP_LIVEREC
...
sUI StSampleVoice::renderBlock(sF32 *buf, sUI blkSz, sF32 a, sF32 b, sF32 _volScale
#ifndef TKSAMPLER_SKIP_LIVEREC
                               , const sF32**_inputsOrNull/*sz=STSAMPLE_MAX_INPUTS*/
#endif // TKSAMPLER_SKIP_LIVEREC
                               ) {
...
#endif // TKSAMPLER_SKIP_WAVETABLE
   {
      ...
      blkLeft = renderBlockNormal(buf, blkSz, smpDat,
#ifndef TKSAMPLER_SKIP_LIVEREC
                                  smpDatLRX,
#endif // TKSAMPLER_SKIP_LIVEREC
                                  a, b, cVolL, cVolR, sVolL, sVolR
...
#ifndef LIBSYNERGY_BUILD
   // Update last played offset (SampleView)
...
void StSampleVoice::renderInt(YAC_Object *_buf, sF32 _volScale
#ifndef TKSAMPLER_SKIP_LIVEREC
                              , const sF32**_inputsOrNull/*sz=STSAMPLE_MAX_INPUTS*/
#endif // TKSAMPLER_SKIP_LIVEREC
                              ) {
         ...
         while(b_playing && (numFrames > 0))
         {
            ...
            else
            {
               ...
               if(b_playing)
               {
                  ...
                  blkSz = blkSz - renderBlock(buf, blkSz, a, b, _volScale
#ifndef TKSAMPLER_SKIP_LIVEREC
                                              , _inputsOrNull
#endif // TKSAMPLER_SKIP_LIVEREC
                                              );
...
#endif // !defined(TKSAMPLER_SKIP_AA_AI) || !defined(TKSAMPLER_SKIP_FILTER)
