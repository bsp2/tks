...
// ----
// ---- created: 05Dec2021
// ---- changed: 06Dec2021, 21Jan2024, 14Jan2025, 11Sep2026
// ----
// ----
// ----
...
static unsigned int ST_PLUGIN_API loc_query_dynamic_param_preset_values(st_plugin_shared_t *_shared,
   ...
   switch(_paramIdx)
   {
      ...
      case PARAM_MODE_2:
         if(NULL != _retValues)
         {
            _retValues[0] = 0.0f;  // lp
            _retValues[1] = 0.34f; // hp
            _retValues[2] = 0.67f; // bp
         }
         return 3u;
      ...
      case PARAM_POLES_2:
         if(NULL != _retValues)
         {
            _retValues[0] = 0.0f;  // 2 poles
            _retValues[1] = 0.5f;  // 4 poles
         }
         return 2u;
   }
   return 0u;
...
static unsigned int ST_PLUGIN_API loc_query_dynamic_param_preset_name(st_plugin_shared_t *_shared,
   ...
   switch(_paramIdx)
   {
      ...
      case PARAM_MODE_2:
         ...
         {
            default: break;
            case 0u:  if(NULL != _retBuf) strcpy(_retBuf, "lp"); return 3u;
            case 1u:  if(NULL != _retBuf) strcpy(_retBuf, "hp"); return 3u;
            case 2u:  if(NULL != _retBuf) strcpy(_retBuf, "bp"); return 3u;
         }
         break;
      ...
      case PARAM_POLES_2:
         ...
         {
            default: break;
            case 0u:  if(NULL != _retBuf) strcpy(_retBuf, "12dB"); return 5u;
            case 1u:  if(NULL != _retBuf) strcpy(_retBuf, "24dB"); return 5u;
         }
         break;
   }
   return 0u;
...
static void ST_PLUGIN_API loc_prepare_block(st_plugin_voice_t *_voice,
   ...
   modReso2 = Dstplugin_scale(modReso2, 1, 10);
