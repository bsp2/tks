...
// ----
// ---- created: 24May2020
// ---- changed: 25May2020, 31May2020, 08Jun2020, 05Jan2022, 21Jan2024, 27Sep2024, 11Sep2026
// ----
// ----
// ----
...
typedef struct dly_2_info_s {
   st_plugin_info_t base;
} dly_2_info_t;

typedef struct dly_2_shared_s {
   st_plugin_shared_t base;
   float params[NUM_PARAMS];
} dly_2_shared_t;

typedef struct dly_2_voice_s {
...
static void ST_PLUGIN_API loc_set_sample_rate(st_plugin_voice_t *_voice,
   ...
   ST_PLUGIN_VOICE_CAST(dly_2_voice_t);
...
static float ST_PLUGIN_API loc_get_param_value(st_plugin_shared_t *_shared,
   ...
   ST_PLUGIN_SHARED_CAST(dly_2_shared_t);
...
static void ST_PLUGIN_API loc_prepare_block(st_plugin_voice_t *_voice,
   ...
   ST_PLUGIN_VOICE_CAST(dly_2_voice_t);
   ST_PLUGIN_VOICE_SHARED_CAST(dly_2_shared_t);
   (void)_freqHz;
   (void)_note;
   (void)_vol;
   (void)_pan;
...
static void ST_PLUGIN_API loc_process_replace(st_plugin_voice_t  *_voice,
   ...
   for(unsigned int i = 0u; i < _numFrames; i++)
   {
      ...
      voice->dly_l.push(l + voice->dly_r.last_out * voice->mod_fb_r2l_cur, voice->mod_fb_l_cur);
...
static st_plugin_shared_t *ST_PLUGIN_API loc_shared_new(st_plugin_info_t *_info) {
   dly_2_shared_t *ret = (dly_2_shared_t *)malloc(sizeof(dly_2_shared_t));
   if(NULL != ret)
   {
...
static st_plugin_voice_t *ST_PLUGIN_API loc_voice_new(st_plugin_info_t *_info, unsigned int _voiceIdx) {
   (void)_voiceIdx;
   dly_2_voice_t *ret = (dly_2_voice_t *)malloc(sizeof(dly_2_voice_t));
   if(NULL != ret)
   {
...
extern "C" {
st_plugin_info_t *dly_2_init(void) {

   dly_2_info_t *ret = (dly_2_info_t *)malloc(sizeof(dly_2_info_t));
   ...
   if(NULL != ret)
   {
      ...
      ret->base.id          = "bsp dly 2";  // unique id. don't change this in future builds.
      ret->base.author      = "bsp";
      ret->base.name        = "delay 2";
      ret->base.short_name  = "dly 2";
