// ----
// ---- file   : biquad_brf_1.cpp
// ---- author : Bastian Spiegel <bs@tkscript.de>
// ---- legal  : (c) 2020-2026 by Bastian Spiegel. 
// ----          Distributed under terms of the GNU LESSER GENERAL PUBLIC LICENSE (LGPL). See 
// ----          http://www.gnu.org/licenses/licenses.html#LGPL or COPYING for further information.
// ----
// ---- info   : a biquad band reject filter that supports per-sample-frame parameter interpolation
// ----
// ---- created: 21May2020
// ---- changed: 24May2020, 31May2020, 08Jun2020, 21Jan2024, 11Sep2026
// ----
// ----
// ----
...
typedef struct biquad_brf_1_info_s {
   st_plugin_info_t base;
} biquad_brf_1_info_t;

typedef struct biquad_brf_1_shared_s {
   st_plugin_shared_t base;
   float params[NUM_PARAMS];
} biquad_brf_1_shared_t;

typedef struct biquad_brf_1_voice_s {
   ...
   StBiquad brf_1_l;
   StBiquad brf_1_r;
} biquad_brf_1_voice_t;


static void ST_PLUGIN_API loc_set_sample_rate(st_plugin_voice_t *_voice,
                                              float              _sampleRate
                                              ) {
   ST_PLUGIN_VOICE_CAST(biquad_brf_1_voice_t);
...
static float ST_PLUGIN_API loc_get_param_value(st_plugin_shared_t *_shared,
   ...
   ST_PLUGIN_SHARED_CAST(biquad_brf_1_shared_t);
...
static void ST_PLUGIN_API loc_prepare_block(st_plugin_voice_t *_voice,
   ...
   ST_PLUGIN_VOICE_CAST(biquad_brf_1_voice_t);
   ST_PLUGIN_VOICE_SHARED_CAST(biquad_brf_1_shared_t);
   (void)_freqHz;
   (void)_note;
   (void)_vol;
   (void)_pan;
   ...
   if(_numFrames > 0u)
   {
      ...
      voice->brf_1_l.calcParams(_numFrames,
                                StBiquad::BRF,
                                0.0f/*gainDB*/,
                                modFreqL,
                                modQ
      ...
      voice->brf_1_r.calcParams(_numFrames,
                                StBiquad::BRF,
                                0.0f/*gainDB*/,
                                modFreqR,
                                modQ
   ...
   else
   {
      ...
      voice->brf_1_l.reset();
      voice->brf_1_l.calcParams(1u/*numFrames*/,
                                StBiquad::BRF,
                                0.0f/*gainDB*/,
                                modFreqL,
                                modQ
      ...
      voice->brf_1_r.reset();
      voice->brf_1_r.calcParams(44u/*numFrames*/,
                                StBiquad::BRF,
                                0.0f/*gainDB*/,
                                modFreqR,
                                modQ
...
static void ST_PLUGIN_API loc_process_replace(st_plugin_voice_t  *_voice,
   ...
   for(unsigned int i = 0u; i < _numFrames; i++)
   {
      ...
      float outL = voice->brf_1_l.filter(l * voice->mod_drive_cur);
      float outR = voice->brf_1_r.filter(r * voice->mod_drive_cur);
...
static st_plugin_shared_t *ST_PLUGIN_API loc_shared_new(st_plugin_info_t *_info) {
   biquad_brf_1_shared_t *ret = (biquad_brf_1_shared_t *)malloc(sizeof(biquad_brf_1_shared_t));
   if(NULL != ret)
   {
...
static st_plugin_voice_t *ST_PLUGIN_API loc_voice_new(st_plugin_info_t *_info, unsigned int _voiceIdx) {
   (void)_voiceIdx;
   biquad_brf_1_voice_t *ret = (biquad_brf_1_voice_t *)malloc(sizeof(biquad_brf_1_voice_t));
   if(NULL != ret)
   {
      memset((void*)ret, 0, sizeof(*ret));
      ret->base.info = _info;
...
extern "C" {
st_plugin_info_t *biquad_brf_1_init(void) {
   biquad_brf_1_info_t *ret = NULL;

   ret = (biquad_brf_1_info_t *)malloc(sizeof(biquad_brf_1_info_t));
   ...
   if(NULL != ret)
   {
      ...
      ret->base.id          = "bsp biquad brf 1";  // unique id. don't change this in future builds.
      ret->base.author      = "bsp";
      ret->base.name        = "biquad band reject filter 1";
      ret->base.short_name  = "bq brf 1";
