...
/* ./.libs/lt-testjitter.c - temporary wrapper executable for .libs/testjitter.exe
   Generated by libtool (GNU libtool) 2.4.6.40-6ca5-dirty

   The testjitter program cannot be directly executed until all the libtool
...
const char * TARGET_PROGRAM_NAME = "testjitter.exe"; /* hopefully, no .exe */
...
void lt_dump_script (FILE* f)
{
  fputs ("#! /bin/sh\n", f);
  fputs ("\n", f);
  fputs ("# testjitter - temporary wrapper script for .libs/testjitter.exe\n", f);
  fputs ("# Generated by libtool (GNU libtool) 2.4.6.40-6ca5-dirty\n", f);
  fputs ("#\n", f);
  fputs ("# The testjitter program cannot be directly executed until all the libtool\n", f);
  ...
  fputs ("    echo \"testjitter.exe:testjitter:$LINENO: libtool wrapper (GNU libtool) 2.4.", f);
  fputs ("6.40-6ca5-dirty\" 1>&2\n", f);
  fputs ("  fi\n", f);
  fputs ("}\n", f);
  fputs ("\n", f);
  ...
  fputs ("  for lt_arg\n", f);
  fputs ("  do\n", f);
  fputs ("    $ECHO \"testjitter.exe:testjitter:$LINENO: newargv[$lt_dump_args_N]: $lt_arg", f);
  fputs ("\"\n", f);
  ...
  fputs ("\n", f);
  fputs ("      if test -n \"$lt_option_debug\"; then\n", f);
  fputs ("        $ECHO \"testjitter.exe:testjitter:$LINENO: newargv[0]: $progdir/$program", f);
  fputs ("\" 1>&2\n", f);
