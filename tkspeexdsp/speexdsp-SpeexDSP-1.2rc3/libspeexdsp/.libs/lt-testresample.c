...
/* ./.libs/lt-testresample.c - temporary wrapper executable for .libs/testresample.exe
...
const char * TARGET_PROGRAM_NAME = "testresample.exe"; /* hopefully, no .exe */
...
void lt_dump_script (FILE* f)
{
  fputs ("#! /bin/sh\n", f);
  fputs ("\n", f);
  fputs ("# testresample - temporary wrapper script for .libs/testresample.exe\n", f);
  fputs ("# Generated by libtool (GNU libtool) 2.4.6.40-6ca5-dirty\n", f);
  fputs ("#\n", f);
  fputs ("# The testresample program cannot be directly executed until all the libtool\n", f);
  ...
  fputs ("    echo \"testresample.exe:testresample:$LINENO: libtool wrapper (GNU libtool) ", f);
  fputs ("2.4.6.40-6ca5-dirty\" 1>&2\n", f);
  fputs ("  fi\n", f);
  fputs ("}\n", f);
  fputs ("\n", f);
  ...
  fputs ("  for lt_arg\n", f);
  fputs ("  do\n", f);
  fputs ("    $ECHO \"testresample.exe:testresample:$LINENO: newargv[$lt_dump_args_N]: $lt", f);
  fputs ("_arg\"\n", f);
  ...
  fputs ("\n", f);
  fputs ("      if test -n \"$lt_option_debug\"; then\n", f);
  fputs ("        $ECHO \"testresample.exe:testresample:$LINENO: newargv[0]: $progdir/$pro", f);
  fputs ("gram\" 1>&2\n", f);
  ...
  fputs ("\n", f);
  fputs ("  program='testresample.exe'\n", f);
