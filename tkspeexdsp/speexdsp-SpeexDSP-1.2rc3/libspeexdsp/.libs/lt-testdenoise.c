...
/* ./.libs/lt-testdenoise.c - temporary wrapper executable for .libs/testdenoise.exe
   Generated by libtool (GNU libtool) 2.4.6.40-6ca5-dirty

   The testdenoise program cannot be directly executed until all the libtool
...
const char * LIB_PATH_VALUE   = "F:\\git\\Rack\\dep\\speexdsp-SpeexDSP-1.2rc3\\libspeexdsp\\.libs;";
const char * EXE_PATH_VARNAME = "PATH";
const char * EXE_PATH_VALUE   = "F:\\git\\Rack\\dep\\speexdsp-SpeexDSP-1.2rc3\\libspeexdsp\\.libs;F:\\git\\Rack\\dep\\lib;F:\\git\\Rack\\dep\\bin;";
const char * TARGET_PROGRAM_NAME = "testdenoise.exe"; /* hopefully, no .exe */
...
void lt_dump_script (FILE* f)
{
  fputs ("#! /bin/sh\n", f);
  fputs ("\n", f);
  fputs ("# testdenoise - temporary wrapper script for .libs/testdenoise.exe\n", f);
  fputs ("# Generated by libtool (GNU libtool) 2.4.6.40-6ca5-dirty\n", f);
  fputs ("#\n", f);
  fputs ("# The testdenoise program cannot be directly executed until all the libtool\n", f);
  ...
  fputs ("  notinst_deplibs=' libspeexdsp.la'\n", f);
  fputs ("else\n", f);
  ...
  fputs ("    echo \"testdenoise.exe:testdenoise:$LINENO: libtool wrapper (GNU libtool) 2.", f);
  fputs ("4.6.40-6ca5-dirty\" 1>&2\n", f);
  fputs ("  fi\n", f);
  fputs ("}\n", f);
  fputs ("\n", f);
  ...
  fputs ("  for lt_arg\n", f);
  fputs ("  do\n", f);
  fputs ("    $ECHO \"testdenoise.exe:testdenoise:$LINENO: newargv[$lt_dump_args_N]: $lt_a", f);
  fputs ("rg\"\n", f);
  ...
  fputs ("\n", f);
  fputs ("      if test -n \"$lt_option_debug\"; then\n", f);
  fputs ("        $ECHO \"testdenoise.exe:testdenoise:$LINENO: newargv[0]: $progdir/$progr", f);
  fputs ("am\" 1>&2\n", f);
  ...
  fputs ("    PATH=/f/git/Rack/dep/speexdsp-SpeexDSP-1.2rc3/libspeexdsp/.libs:/f/git/Rack", f);
  fputs ("/dep/./lib:/f/git/Rack/dep/./bin:$PATH\n", f);
  fputs ("\n", f);
  fputs ("    # Add our own library path to PATH\n", f);
  fputs ("    PATH=\"/f/git/Rack/dep/speexdsp-SpeexDSP-1.2rc3/libspeexdsp/.libs:$PATH\"\n", f);
  fputs ("\n", f);
