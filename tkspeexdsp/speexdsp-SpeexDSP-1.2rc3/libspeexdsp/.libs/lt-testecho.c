...
/* ./.libs/lt-testecho.c - temporary wrapper executable for .libs/testecho.exe
   Generated by libtool (GNU libtool) 2.4.6.40-6ca5-dirty

   The testecho program cannot be directly executed until all the libtool
...
const char * TARGET_PROGRAM_NAME = "testecho.exe"; /* hopefully, no .exe */
...
void lt_dump_script (FILE* f)
{
  fputs ("#! /bin/sh\n", f);
  fputs ("\n", f);
  fputs ("# testecho - temporary wrapper script for .libs/testecho.exe\n", f);
  fputs ("# Generated by libtool (GNU libtool) 2.4.6.40-6ca5-dirty\n", f);
  fputs ("#\n", f);
  fputs ("# The testecho program cannot be directly executed until all the libtool\n", f);
  ...
  fputs ("    echo \"testecho.exe:testecho:$LINENO: libtool wrapper (GNU libtool) 2.4.6.40", f);
  ...
  fputs ("  for lt_arg\n", f);
  fputs ("  do\n", f);
  fputs ("    $ECHO \"testecho.exe:testecho:$LINENO: newargv[$lt_dump_args_N]: $lt_arg\"\n", f);
  ...
  fputs ("\n", f);
  fputs ("      if test -n \"$lt_option_debug\"; then\n", f);
  fputs ("        $ECHO \"testecho.exe:testecho:$LINENO: newargv[0]: $progdir/$program\" 1>", f);
  fputs ("&2\n", f);
