...
/* #define paUInt8          ((PaSampleFormat) 0x00000020) /\**< @see PaSampleFormat *\/ */
   ...
   */
    ...
    */
   YM void _GetDeviceInfo(sSI _devIdx, YAC_Value *_r);
    ...
    */
   YM sSI _OpenStream(YAC_Object *_inParams, YAC_Object *_outParams, sF32 _sampleRate, YAC_Object *_streamCbk, YAC_Object *_retStream);
