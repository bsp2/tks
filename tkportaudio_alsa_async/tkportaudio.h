...
// (note) in bytes
#define TKPORTAUDIO_MAX_BUFSIZE (65536 * sizeof(sF32))
/* #define TKPORTAUDIO_MAX_CHANNELS 2 */

// must be a power of two
#define TKPORTAUDIO_RINGSIZE (16384u)

/* #define PAR_FRAG         2 */
/* #define PAR_LATENCY_BITS 6 // should be 7 ! */
/* #define PAR_LATENCY      (1<< PAR_LATENCY_BITS) */
/* #define PAR_LATENCY_SEC  ( PAR_LATENCY / ((float)PAR_RATE) ) */
/* #define PAR_BITS         16       // do not change */
/* #define PAR_FORMAT       paInt16 */
/* #define PAR_CHANNELS     2        // do not change */
/* #define PAR_FRAGBYTESIZE (PAR_CHANNELS * PAR_LATENCY * (PAR_BITS >> 3)) */
/* #define PAR_DEVNAME_HW    "hw:0" */
/* #define PAR_DEVNAME_DEF   "default" */
//#define PAR_DEVNAME       "hw:2,0,0"
/* #define PAR_TEST_SIZEPOT defined */
