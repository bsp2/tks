`tkui` is a cross-platform user interface toolkit built on top of [tkopengl](../tkopengl), [tksdl](../tksdl2), [tkminnie](../minnie), [tkfreetype2](../tkfreetype2), and [tkmath](../tkmath).
