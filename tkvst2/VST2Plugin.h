...
///          03Apr2018, 22Jun2018, 29Jun2018, 26Aug2019, 31Dec2021, 27Feb2022, 25Feb2023
///          24Oct2023, 01Jul2025, 26May2026
///
///
///
...
#define VST2PLUGIN_SIGNAL_ONMACOSKEYDOWN             4
#define VST2PLUGIN_SIGNAL_ONAUDIOMASTERPARAMEDIT     5
#define VST2PLUGIN_NUM_SIGNALS                       6
...
#define VST2PLUGIN_CATEGORY_GENERATOR      YCI  (11u)
  ...
  public:
   ...
   CRITICAL_SECTION mtx_dispatcher;

   inline void beginDispatch (void) { ::EnterCriticalSection(&mtx_dispatcher); }
   inline void endDispatch   (void) { ::LeaveCriticalSection(&mtx_dispatcher); }

   CRITICAL_SECTION mtx_events;
   inline void beginEvents(void) { ::EnterCriticalSection(&mtx_events); }
   inline void endEvents(void)   { ::LeaveCriticalSection(&mtx_events); }
   ...
   static CRITICAL_SECTION mtx_shell_plugin_uid;
  ...
  public:
   ...
   sSI ui_window_top;
   sSI ui_window_right;
   sSI ui_window_bottom;

   sSI queued_resize_w;  // audioMasterSizeWindow
   sSI queued_resize_h;
   sUI queued_window_schedule_ms;
  ...
  public:
   ...
   static HANDLE databridge_host_ev;
...
public:
   ...
   void queueResizeWindow (sUI _w, sUI _h);
