...
/// ----          15-Dec-2018 / 28-Dec-2018 / 11-May-2019 / 28-Jun-2019 / 09-Jul-2019 / 31-Jul-2019
...
/// Define to build with no "yac_host" dependencies
/* #define YAC_NO_HOST defined */
...
// ----
#ifndef YAC_PRINTF
/// ---- Define if you want a YAC_Host::printf() utility method
...
//#define YAC_SKIP_OBJECT_METHODS defined  // skip all YAC_Object methods (YAC_NO_HOST / LIBSYNERGY_BUILD)
...
#ifdef __APPLE__
#ifndef YAC_MACOS
  #define YAC_MACOS defined
#endif // YAC_MACOS
  #define YAC_POSIX defined
#if __BYTE_ORDER__ == __ORDER_LITTLE_ENDIAN__  // see https://gcc.gnu.org/onlinedocs/cpp/Common-Predefined-Macros.html
  #define YAC_LITTLE_ENDIAN defined
#else
  #define YAC_BIG_ENDIAN defined
#endif // __BYTE_ORDER__ == __ORDER_LITTLE_ENDIAN__
  #undef YAC_OSNAME
  #define YAC_OSNAME "macos"
#endif
// ---- NeXT ? (untested)
#ifdef NeXT
#ifndef YAC_NEXT
...
#define sM_2PI      6.2831853071795864769252867665590058
...
#define sM_Ef       2.7182818284590452353602874713526625f
#define sM_LOG2Ef   1.4426950408889634073599246810018922f
#define sM_LOG10Ef  0.4342944819032518276511289189166051f
#define sM_LN2f     0.6931471805599453094172321214581766f
#define sM_LN10f    2.3025850929940456840179914546843642f
#define sM_2PIf     6.2831853071795864769252867665590058f
#define sM_PIf      3.1415926535897932384626433832795029f
#define sM_PI_2f    1.5707963267948966192313216916397514f
#define sM_PI_4f    0.7853981633974483096156608458198757f
#define sM_1_PIf    0.3183098861837906715377675267450287f
#define sM_2_PIf    0.6366197723675813430755350534900574f
#define sM_2_SQRTPf 1.1283791670955125738961589031215452f
#define sM_SQRT1_2f 0.7071067811865475244008443621048490f
#define sM_SQRT2f   1.4142135623730950488016887242096981f
...
#define sM_2PIl         6.2831853071795864769252867665590058L  /* tau */
...
typedef void * YAC_ThreadHandle;

// ---- thread entry function type and priorities ----
typedef void *(*yac_thread_fxn_t)(void *_userData);
#define YAC_THREAD_PRIORITY_ABOVE_NORMAL 1
#define YAC_THREAD_PRIORITY_BELOW_NORMAL -1
#define YAC_THREAD_PRIORITY_HIGHEST 2
#define YAC_THREAD_PRIORITY_IDLE -15
#define YAC_THREAD_PRIORITY_LOWEST -2
#define YAC_THREAD_PRIORITY_NORMAL 0
#define YAC_THREAD_PRIORITY_TIME_CRITICAL 15
...
//        'userdata' is the previously registered userdata (may be NULL)
//        's'        is the currently printed string (never NULL. reference must not be kept)
typedef void (*yac_printhook_fxn_t)(YAC_String *_output, void *_userdata, YAC_String *_s);
...
// ---- constant memory pointer union ----
typedef union _yaccmemptr {
   /* const size_t       sz; */
   const void        *any;
   const sU8         *u8;
   const sS8         *s8;
...
enum __yac_class_IDs {
   ...
   YAC_CLID_STRING8,         // 35: variation of String that comes with preallocated char buffer of 8 chars
   YAC_CLID_STRING16,        // 36: variation of String that comes with preallocated char buffer of 16 chars
   YAC_CLID_STRING32,        // 37: variation of String that comes with preallocated char buffer of 32 chars
   YAC_CLID_STRING64,        // 38: variation of String that comes with preallocated char buffer of 64 chars
   YAC_CLID_STRING128,       // 39: variation of String that comes with preallocated char buffer of 128 chars
   YAC_CLID_INTARRAY8,       // 40: variation of IntArray that comes with a preallocated buffer of 8 ints
   YAC_CLID_INTARRAY16,      // 41: variation of IntArray that comes with a preallocated buffer of 16 ints
   YAC_CLID_INTARRAY32,      // 42: variation of IntArray that comes with a preallocated buffer of 32 ints
   YAC_CLID_INTARRAY64,      // 43: variation of IntArray that comes with a preallocated buffer of 64 ints
   YAC_CLID_INTARRAY128,     // 44: variation of IntArray that comes with a preallocated buffer of 128 ints
   YAC_CLID_FLOATARRAY8,     // 45: variation of FloatArray that comes with a preallocated buffer of 8 floats
   YAC_CLID_FLOATARRAY16,    // 46: variation of FloatArray that comes with a preallocated buffer of 16 floats
   YAC_CLID_FLOATARRAY32,    // 47: variation of FloatArray that comes with a preallocated buffer of 32 floats
   YAC_CLID_FLOATARRAY64,    // 48: variation of FloatArray that comes with a preallocated buffer of 64 floats
   YAC_CLID_FLOATARRAY128,   // 49: variation of FloatArray that comes with a preallocated buffer of 128 floats

   YAC_CLID_LFSR,            // 50: linear feedback shift register based pseudo random number generator
   YAC_CLID_LFSR_NR,         // 51: Non-Repeating linear feedback shift register based pseudo random number generator
...
#define YAC_LOSTKEY      ~0u     // indicates that YAC_String hashkey needs to be recalc'd
...
#ifdef YAC_NO_HOST
#define YAC_CHK(a,b) (a)
#define YAC_BCHK(a,b) (a)
#else
...
#ifdef YAC_NO_HOST
#define YAC_NEW(a) ::new(std::nothrow)a()
#else
...
#define YAC_DELETE_ARRAY_SAFE(a) { if(NULL != a) { delete [] a; a = NULL; } else { } } (void)0
...
enum __yacoperators {
    ...
    YAC_OP_SHL       = 6,
    YAC_OP_SHR       = 7,
    YAC_OP_CEQ       = 8,  // compare value (a==b)
    YAC_OP_CNE       = 9,
    YAC_OP_CLE       = 10,
    YAC_OP_CLT       = 11,
    YAC_OP_CGE       = 12,
    ...
    YAC_OP_LEOR      = 21,
    YAC_OP_NEG       = 22,
    YAC_OP_INIT      = 23, // init class, call constructors (or put on cs list)
    YAC_OP_BEQ       = 24, // compare exact int/float bit pattern or object/string address (@(a)==@(b) optimization)
    YAC_OP_BNE       = 25, //                                                              (@(a)!=@(b) optimization)
    YAC_NUMOPERATORS = 26
};

// ---- double arg operator priorities (sUI YAC_Object::yacOperatorPriority(void))
#define YAC_OP_PRIO_NONE     0x00000000
...
public:
...
#ifdef YAC_GCC
      // work-around for GCC 12.2.0 issue (warning when either new or delete has been inlined but the other has not)
   ...
   void *operator new    (size_t, void *_this)
#ifdef YAC_GCC
      // work-around for GCC 12.2.0 issue (warning when either new or delete has been inlined but the other has not)
      __attribute__ ((noinline))
#endif // YAC_GCC
...
public:
  ...
  virtual void             YAC_VCALL yacGetConstantStringList        (YAC_String *);      // write constant list to _retstring. example: "CONST_A:42 CONST_B:77 CONST_C:$7f"
  ...
  virtual sBool            YAC_VCALL yacArrayAlloc                   (sUI _sx, sUI _sy=0, sUI _type=0, sUI _elementbytesize=0); // allocate new array elements
  virtual sBool            YAC_VCALL yacArrayRealloc                 (sUI _sx, sUI _sy=0, sUI _type=0, sUI _elementbytesize=0); // re-allocate new array elements
  ...
  virtual sF32             YAC_VCALL yacEnvGetValue                  (void);
  virtual void             YAC_VCALL yacEnvTickPrecise               (sF32 _dt);
  virtual void             YAC_VCALL yacEnvSetTime                   (sF32 _t);
...
public:
	sUI byteOrder;
   /* sUI bit_offset;  // 0..7. used for bitstream i/o */
};
...
public:
    ...
    void  YAC_VCALL yacArraySet                (void *_context, sUI _index, YAC_Value *_value); // set a single value
    void  YAC_VCALL yacArrayGet                (void *_context, sUI _index, YAC_Value *_r);     // read a single value
...
public:
    ...
    virtual void         YAC_VCALL yacPrintHookAdd            (yac_printhook_fxn_t _fxn, YAC_String *_output, void *_userdata) = 0;
    virtual void         YAC_VCALL yacPrintHookRemove         (yac_printhook_fxn_t _fxn, YAC_String *_output, void *_userdata) = 0;
    ...
    // ----
    // ----
    virtual YAC_ExceptionId  YAC_VCALL yacExceptionRegister       (const char *_name, YAC_ExceptionId _baseException) = 0; // register new exception type. Return exception id or 0==registration failed
    ...
    virtual void             YAC_VCALL vtable_entry_8_5_reserved  (void) = 0;
    virtual void             YAC_VCALL vtable_entry_8_6_reserved  (void) = 0;
    virtual void             YAC_VCALL vtable_entry_8_7_reserved  (void) = 0;
    virtual void             YAC_VCALL vtable_entry_8_8_reserved  (void) = 0;
    virtual void             YAC_VCALL vtable_entry_8_9_reserved  (void) = 0;
    ...
    // ----
    // ----
    virtual YAC_ThreadHandle YAC_VCALL yacThreadNew               (void) = 0;
    virtual void             YAC_VCALL yacThreadAllocEventQueue   (YAC_ThreadHandle _thread, sSI _size) = 0;
    virtual sBool            YAC_VCALL yacThreadStart             (YAC_ThreadHandle _thread, yac_thread_fxn_t _fxn, void *_userData) = 0;
    virtual void             YAC_VCALL yacThreadSetPriority       (YAC_ThreadHandle _thread, yac_thread_priority_t _priority) = 0;
    virtual void             YAC_VCALL yacThreadSetCPUCore        (YAC_ThreadHandle _thread, sSI _coreIdx/*-1=any*/) = 0;
    virtual void             YAC_VCALL yacThreadSendEvent         (YAC_ThreadHandle _thread, YAC_Event *_event) = 0;
    virtual YAC_Event *      YAC_VCALL yacThreadPeekEvent         (YAC_ThreadHandle _thread) = 0;
    virtual YAC_Event *      YAC_VCALL yacThreadPeekEventById     (YAC_ThreadHandle _thread, sSI _id) = 0;
    // (note) WaitEvent* returns null or YAC_Event (which must be deleted by caller via yacDelete())
    virtual YAC_Event *      YAC_VCALL yacThreadWaitEvent         (YAC_ThreadHandle _thread, sUI _timeoutMS) = 0;
    virtual YAC_Event *      YAC_VCALL yacThreadWaitEventById     (YAC_ThreadHandle _thread, sSI _id, sUI _timeoutMS) = 0;
    virtual sUI              YAC_VCALL yacThreadRand              (YAC_ThreadHandle _thread) = 0;
    virtual void             YAC_VCALL yacThreadSRand             (YAC_ThreadHandle _thread, sUI _seed) = 0;
    virtual void             YAC_VCALL yacThreadYield             (void) = 0;
    virtual void             YAC_VCALL yacThreadDelay             (void) = 0;
...
public:
	enum __stringflags {
      QUOT   = (1u << 24),  // \"\"
      QUOTR  = (1u << 25),  // ~; region quote ~;
      QUOT2  = (1u << 26),  // \'\'
      DEL    = (1u << 31)   // chars are owned by this string
   };
...
public:
   ...
   sBool alloc(sUI _num) {
      ...
      if(_num > 0u)
      {
         elements = new(std::nothrow)sF32[_num];
         if(NULL != elements)
         {
            num_elements  = _num;
            max_elements  = _num;
...
public:
   ...
   sBool alloc(sUI _num) {
      ...
      if(_num > 0u)
      {
         elements = new(std::nothrow)sSI[_num];
         if(NULL != elements)
         {
            num_elements  = _num;
            max_elements  = _num;
...
class YAC_API YAC_UnsignedLong    : public YAC_Object { public: sU64 value; };
...
#define YAC_New_UnsignedLong()    (YAC_UnsignedLong*)    yac_host->yacNewByID (YAC_CLID_UNSIGNEDLONG   )
...
#define YAC_New_PointerArray()    (YAC_PointerArray*)    yac_host->yacNewByID (YAC_CLID_POINTERARRAY   )
...
#else
// no host
#define YAC_New_Boolean()         (YAC_Boolean*)         YAC_NEW (YAC_Boolean        )
#define YAC_New_Byte()            (YAC_Byte*)            YAC_NEW (YAC_Byte           )
#define YAC_New_Short()           (YAC_Short*)           YAC_NEW (YAC_Short          )
#define YAC_New_Integer()         (YAC_Integer*)         YAC_NEW (YAC_Integer        )
#define YAC_New_Long()            (YAC_Long*)            YAC_NEW (YAC_Long           )
#define YAC_New_UnsignedByte()    (YAC_UnsignedByte*)    YAC_NEW (YAC_UnsignedByte   )
#define YAC_New_UnsignedShort()   (YAC_UnsignedShort*)   YAC_NEW (YAC_UnsignedShort  )
#define YAC_New_UnsignedInteger() (YAC_UnsignedInteger*) YAC_NEW (YAC_UnsignedInteger)
#define YAC_New_UnsignedLong()    (YAC_UnsignedLong*)    YAC_NEW (YAC_UnsignedLong   )
#define YAC_New_Float()           (YAC_Float*)           YAC_NEW (YAC_Float          )
#define YAC_New_Double()          (YAC_Double*)          YAC_NEW (YAC_Double         )
#define YAC_New_String()          (YAC_String*)          YAC_NEW (YAC_String         )
#define YAC_New_Event()           (YAC_Event*)           YAC_NEW (YAC_Event          )
#define YAC_New_Value()           (YAC_ValueObject*)     YAC_NEW (YAC_Value          )
#define YAC_New_ListNode()        (YAC_ListNode*)        YAC_NEW (YAC_ListNode       )
#define YAC_New_TreeNode()        (YAC_TreeNode*)        YAC_NEW (YAC_TreeNode       )
#define YAC_New_IntArray()        (YAC_IntArray*)        YAC_NEW (YAC_IntArray       )
#define YAC_New_FloatArray()      (YAC_FloatArray*)      YAC_NEW (YAC_FloatArray     )
#define YAC_New_StringArray()     (YAC_StringArray*)     YAC_NEW (YAC_StringArray    )
#define YAC_New_ObjectArray()     (YAC_ObjectArray*)     YAC_NEW (YAC_ObjectArray    )
#define YAC_New_ClassArray()      (YAC_ClassArray*)      YAC_NEW (YAC_ClassArray     )
#define YAC_New_ValueArray()      (YAC_ValueArray*)      YAC_NEW (YAC_ValueArray     )
#define YAC_New_PointerArray()    (YAC_PointerArray*)    YAC_NEW (YAC_PointerArray   )
#define YAC_New_Buffer()          (YAC_Buffer*)          YAC_NEW (YAC_Buffer         )
#endif // YAC_NO_HOST
...
#define YAC_Is_Class(a)           YAC_BCHK(a, YAC_CLID_CLASS)
...
// ----
// ----
#define YAC_FLT_EPSILON 0.000005f
#define YAC_DBL_EPSILON 0.000000000005
...
#else
#define Dfltnonzero(a)     (0.0f != a)
#define Dfltequal(a, b)    (a == b)
#define Dfltnotequal(a, b) (a != b)
#define Dfltzero(a)        (0.0f == a)
#define Ddblnonzero(a)     (0.0 != a)
#define Ddblequal(a,b)     (a == b)
#define Ddblnotequal(a, b) (a != b)
#define Ddblzero(a)        (0.0 == a)
...
#else
#define Dyac_throw(a, b) while(0)
#define Dyac_throw_def(a, b) while(0)
#endif // YAC_NO_HOST
...
#define YAC_CAST_STRING(l,a) YAC_String *l = (YAC_String*) a
...
#define Dyac_denorm_64(a) ( ((a)+10.0) - 10.0 ) // kb's denormalize trick!
...
/* #define Dyac_chknan_32(a) ( ((*(sUI*)&(a)) == 0x7F820000u) || ((*(sUI*)&(a)) == 0xFF9112AAu) || ((*(sUI*)&(a)) == 0xFFFFFFFFu) ) */
#define Dyac_chknan_32(a) ( 0x3FC00000u == ((*(sUI*)&(a)) & 0x3FC00000u) )
...
#ifdef YAC_WIN32
#define Dyac_snprintf _snprintf
#define Dyac_vsnprintf _vsnprintf
#else
#define Dyac_snprintf snprintf
#define Dyac_vsnprintf vsnprintf
#endif // YAC_WIN32
...
extern sUI yac_host_yacGetDebugLevel (void);
#else
#define Dyac_host_printf yac_host->printf
#define Dyac_host_yacMilliSeconds yac_host->yacMilliSeconds
#define Dyac_host_yacGetDebugLevel yac_host->yacGetDebugLevel
#endif // YAC_NO_HOST
