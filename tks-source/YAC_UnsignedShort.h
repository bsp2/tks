...
///
#ifndef YAC_UNSIGNEDSHORT_H__
#define YAC_UNSIGNEDSHORT_H__


class YAC_UnsignedShort : public YAC_Object {
public:
   sU16 value;

public:
   YAC_UnsignedShort  (void);
   ~YAC_UnsignedShort ();
   ...
   sUI   YAC_VCALL yacOperatorPriority  (void) { return YAC_OP_PRIO_SHORT; }
   ...
   void  myOperator          (sSI, sU16, YAC_Value *_ret);
   void  setValue            (sSI);
   sSI   getValue            (void);
