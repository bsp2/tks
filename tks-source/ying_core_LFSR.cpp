// ---- ying_core_LFSR.cpp: auto generated by YInG - the YAC interface generator (Sun, 26/Jul/2026 15:22:47)
...
sSI   YAC_CALL LFSR__getState       (void *                        );
void  YAC_CALL LFSR__setState       (void *, yacmemptr             );
#endif // YAC_NO_HOST
...
sUI          YAC_VCALL _LFSR::yacMethodGetNum                  (void) {return 7;}
const char **YAC_VCALL _LFSR::yacMethodGetNames                (void) {
#ifndef YAC_NO_HOST
static const char *r[]={"operator", "init", "rands", "randu", "randf", "getState", "setState"}; return r;
#else
return 0;
#endif // YAC_NO_HOST
}
...
#ifndef YAC_NO_HOST
static const sUI r[]={2, 2, 0, 0, 1, 0, 1}; return r;
#else
return 0;
#endif // YAC_NO_HOST
}
...
#ifndef YAC_NO_HOST
static const sUI rt0[]={1,3};static const sUI rt1[]={1, 1,};static const sUI rt2[]={0,};static const sUI rt3[]={0,};static const sUI rt4[]={2,};static const sUI rt5[]={0,};static const sUI rt6[]={1,};static const sUI *r[]={rt0, rt1, rt2, rt3, rt4, rt5, rt6}; return r;
#else
return 0;
#endif // YAC_NO_HOST
}
...
#ifndef YAC_NO_HOST
static const sUI r[]={4, 0, 1, 1, 2, 1, 0}; return r;
#else
return 0;
#endif // YAC_NO_HOST
}
...
#ifndef YAC_NO_HOST
static const void *r[]={(void*)Object__operator, (void*)LFSR__init, (void*)LFSR__rands, (void*)LFSR__randu, (void*)LFSR__randf, (void*)LFSR__getState, (void*)LFSR__setState}; return r;
#else
return 0;
#endif // YAC_NO_HOST
}
...
sSI   YAC_CALL LFSR__getState       (void *_o                                ) {return (sSI)((_LFSR*)_o)->getState();}
void  YAC_CALL LFSR__setState       (void *_o, yacmemptr _args               ) {((_LFSR*)_o)->setState(_args.mem[0].si);}
#endif // YAC_NO_HOST
