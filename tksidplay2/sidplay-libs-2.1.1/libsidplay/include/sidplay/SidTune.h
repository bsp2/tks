...
class SID_EXTERN SidTune
{
 ...
 public:  // ----------------------------------------------------------------
    ...
    bool loadYACStream(YAC_Object *_ifs, const bool separatorIsSlash = false);
    ...
    bool loadYACStream(YAC_Object *_ifs, Buffer_sidtt<const uint_least8_t>& bufferRef);
 ...
 private:  // ---------------------------------------------------------------
    ...
    void getFromYACStream(YAC_Object *_ifs);
