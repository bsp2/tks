...
sSI _PortAudio::_OpenStream(YAC_Object *_inParams, YAC_Object *_outParams, sF32 _sampleRate, sUI _framesPerBuffer, YAC_Object *_streamCbk, YAC_Object *_retStream) {
