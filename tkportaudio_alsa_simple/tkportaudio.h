...
#define PAR_FRAG         2 // not used with alsa backend
#define PAR_LATENCY_BITS 8 // should be 7 or smaller, but snd-hda-intel causes lags with values < 8
