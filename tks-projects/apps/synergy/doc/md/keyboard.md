...
| lshift - RETURN               | Edit sample associated with Tracker node audio pattern clip (same as MMB-click) (Eureka sample page)
...
| lctrl - k              | Split pattern and move events to clipboard
| lctrl - lshift - k     | Split pattern and move events to new pattern
| lshift - m             | Merge next pattern (keep)
| lctrl - lshift - m     | Merge next pattern and delete
...
| lctrl - x 3            | Select procedural sample UID (show dialog)
| lctrl - x 4            | Upload pattern to procedural (Eureka) sample and resynthesize
...
| lctrl - x r            | Upload pattern to procedural (Eureka) sample and resynthesize
