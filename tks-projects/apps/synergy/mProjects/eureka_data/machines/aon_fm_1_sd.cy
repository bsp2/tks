...
arg p_mod_noise_seed 0 0 $ffff  group=noise
arg p_mod_noise_env  0 0  1     group=noise
arg p_mod_noise_ms   0 0 2000   group=noise
arg p_mod_noise_amp  0 0 15     group=noise
    ...
    rate:
      ...
      + zlp 1 div=12 sub=$p_mod_wave lin=$p_lin
        ...
        * rmp $p_mod_amp_ms 0 0.99
          ...
          * $p_mod_amp_env
          * $p_mod_amp
        + fsr seed=$p_mod_noise_seed
          * rmp $p_mod_noise_ms 0 0.99
            lut mod_noise clamp=1 lin=$p_lin_lut
            * $p_mod_noise_env
            * $p_mod_noise_amp
