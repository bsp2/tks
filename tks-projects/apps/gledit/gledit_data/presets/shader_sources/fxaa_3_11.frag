...
// implicit uniform used: u_normcoord_scl (2.0 / vp_sz)
...
vec4 fxaa(vec2 pos) {
   return FxaaPixelShader(pos,
                          pos/*fxaaConsolePosPos*/,
                          u_tex,
                          u_tex/*fxaaConsole360TexExpBiasNegOne*/,
                          u_tex/*fxaaConsole360TexExpBiasNegTwo*/,
                          u_normcoord_scl*0.5/*fxaaQualityRcpFrame*/,
                          vec4(0)/*fxaaConsoleRcpFrameOpt*/,
                          vec4(vec2(-u_normcoord_scl), vec2(u_normcoord_scl))/*fxaaConsoleRcpFrameOpt2*/,
