...
SDL_DYNAPI_PROC(void,SDL_GL_Context_Push,(SDL_Window *a),(a),)
SDL_DYNAPI_PROC(void,SDL_GL_Context_Pop,(SDL_Window *a),(a),)
SDL_DYNAPI_PROC(void,SDL_GL_Context_Rebind,(SDL_Window *a),(a),)
