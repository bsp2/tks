...
struct SDL_VideoDevice
{
    ...
    void(*GL_PushContext)(_THIS, SDL_Window * window);  // [bsp] Save current context and bind SDL context
    void(*GL_PopContext)(_THIS, SDL_Window * window);  // [bsp] Restore previous context
