...
struct SDL_GLDriverData
{
    ...
    HDC (WINAPI *wglGetCurrentDC)(void);  // [BSp]
    HGLRC (WINAPI *wglGetCurrentContext)(void);  // [BSp]
...
extern void WIN_GL_PushContext(_THIS, SDL_Window *window);  // [bsp]
extern void WIN_GL_PopContext(_THIS, SDL_Window *window);  // [bsp]
