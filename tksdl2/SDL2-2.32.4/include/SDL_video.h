...
/** [bsp 14Feb2018] Hack to fix Softube and Waves VST plugin UIs */
extern DECLSPEC void SDLCALL SDL_GL_Context_Push(SDL_Window *window);
extern DECLSPEC void SDLCALL SDL_GL_Context_Pop(SDL_Window *window);
extern DECLSPEC void SDLCALL SDL_GL_Context_Rebind(SDL_Window *window);
