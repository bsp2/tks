...
- test_170_begin_lines_pattern
  ...
  ![screenhots](tests/screenshots/test_170_begin_lines_pattern.png)
...
- test_174_lines_rand_aa_vbo
  ...
  ![screenhots](tests/screenshots/test_174_lines_rand_aa_vbo.png)
- test_175_begin_line_strip_miter_closed
  
  ![screenhots](tests/screenshots/test_175_begin_line_strip_miter_closed.png)
- test_176_begin_line_strip_miter_aa_closed
  
  ![screenhots](tests/screenshots/test_176_begin_line_strip_miter_aa_closed.png)
- test_177_lines_rand2_aa_vbo
  
  ![screenhots](tests/screenshots/test_177_lines_rand2_aa_vbo.png)
- test_178_line_strip_flat_bevel_32_pattern
  
  ![screenhots](tests/screenshots/test_178_line_strip_flat_bevel_32_pattern.png)
- test_179_line_strip_flat_bevel_aa_32_pattern
  
  ![screenhots](tests/screenshots/test_179_line_strip_flat_bevel_aa_32_pattern.png)
- test_180_line_strip_flat_bevel_14_2_pattern
  
  ![screenhots](tests/screenshots/test_180_line_strip_flat_bevel_14_2_pattern.png)
- test_181_line_strip_flat_bevel_aa_14_2_pattern
  
  ![screenhots](tests/screenshots/test_181_line_strip_flat_bevel_aa_14_2_pattern.png)
- test_182_begin_line_strip_bevel_pattern
  
  ![screenhots](tests/screenshots/test_182_begin_line_strip_bevel_pattern.png)
- test_183_begin_line_strip_bevel_aa_pattern
  
  ![screenhots](tests/screenshots/test_183_begin_line_strip_bevel_aa_pattern.png)
- test_184_begin_line_strip_bevel_pattern_closed
  
  ![screenhots](tests/screenshots/test_184_begin_line_strip_bevel_pattern_closed.png)
- test_185_begin_line_strip_bevel_aa_pattern_closed
  
  ![screenhots](tests/screenshots/test_185_begin_line_strip_bevel_aa_pattern_closed.png)
- test_186_begin_line_strip_bevel_pattern_alpha
  
  ![screenhots](tests/screenshots/test_186_begin_line_strip_bevel_pattern_alpha.png)
- test_187_begin_line_strip_bevel_aa_pattern_alpha
  
  ![screenhots](tests/screenshots/test_187_begin_line_strip_bevel_aa_pattern_alpha.png)
- test_188_begin_line_strip_bevel_pattern_alpha_closed
  
  ![screenhots](tests/screenshots/test_188_begin_line_strip_bevel_pattern_alpha_closed.png)
- test_189_begin_line_strip_bevel_aa_pattern_alpha_closed
  
  ![screenhots](tests/screenshots/test_189_begin_line_strip_bevel_aa_pattern_alpha_closed.png)
- test_190_begin_line_strip_bevel_pattern_decal
  
  ![screenhots](tests/screenshots/test_190_begin_line_strip_bevel_pattern_decal.png)
- test_191_begin_line_strip_bevel_aa_pattern_decal
  
  ![screenhots](tests/screenshots/test_191_begin_line_strip_bevel_aa_pattern_decal.png)
- test_192_begin_line_strip_bevel_pattern_decal_closed
  
  ![screenhots](tests/screenshots/test_192_begin_line_strip_bevel_pattern_decal_closed.png)
