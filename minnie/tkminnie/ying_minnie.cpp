...
void YAC_CALL YAC_Init_minnie(YAC_Host *_host) {
	...
	static const sUI   __APIC__minLinePattern_arg_types           []={1, 1,};
	static const sUI   __APIC__minLinePatternScale_arg_types      []={2,};
	static const sUI   __APIC__minLinePatternOffset_arg_types     []={2,};
	...
	static const char *__APIC__minLinePatternScale_arg_otypes     []={"",};
	static const char *__APIC__minLinePatternOffset_arg_otypes    []={"",};
	...
	_host->yacRegisterFunction((void*)__APIC__minLinePattern, "minLinePattern", 0, "", 2, __APIC__minLinePattern_arg_types, __APIC__minLinePattern_arg_otypes, 0);
	_host->yacRegisterFunction((void*)__APIC__minLinePatternScale, "minLinePatternScale", 0, "", 1, __APIC__minLinePatternScale_arg_types, __APIC__minLinePatternScale_arg_otypes, 0);
	_host->yacRegisterFunction((void*)__APIC__minLinePatternOffset, "minLinePatternOffset", 0, "", 1, __APIC__minLinePatternOffset_arg_types, __APIC__minLinePatternOffset_arg_otypes, 0);
...
void  YAC_CALL __APIC__minLinePattern(yacmemptr _args                        ) {minLinePattern(_args.mem[0].si, _args.mem[1].si);}
void  YAC_CALL __APIC__minLinePatternScale(yacmemptr _args                   ) {minLinePatternScale(_args.mem[0].f32);}
void  YAC_CALL __APIC__minLinePatternOffset(yacmemptr _args                  ) {minLinePatternOffset(_args.mem[0].f32);}
